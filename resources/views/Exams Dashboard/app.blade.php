...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/exams/mark/check/subjects">تدقيق العلامات</a>
                    <a class="collapse-item" href="/exams/mark/lists">قوائم العلامات</a>

                </div>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/exams/student/lists">
                <i class="fas fa-fw "></i>
        ...
        <!-- Nav Item - Utilities Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseObj"
               aria-expanded="true" aria-controls="collapseObj">
                <i class="fas fa-fw "></i>
                <span>الاعتراضات</span>
            </a>
            <div id="collapseObj" class="collapse" aria-labelledby="headingObj"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">إدارة الاعتراضات</h6>
                    <a class="collapse-item" href="/exams/objection/prac/all">عملي</a>
                    <a class="collapse-item" href="/exams/objection/theo/all">نظري</a>
                </div>
            </div>
        </li>
        <!-- Nav Item - Utilities Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseRePrac"
               aria-expanded="true" aria-controls="collapseRePrac">
                <i class="fas fa-fw "></i>
                <span>إعادة العملي</span>
            </a>
            <div id="collapseRePrac" class="collapse" aria-labelledby="headingRePrac"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/exams/re-prac/manage">إمكانية التسجيل</a>
                    <a class="collapse-item" href="/exams/re-prac/all">الطلبات</a>
                </div>
            </div>
        </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                <form  action="/exams/search" method="GET"
                    ...
                    <div class="input-group">
                        ...
                        <input style="text-align: right" type="text" class="form-control bg-light border-0 small" placeholder="ابحث عن طالب أو مادة"
