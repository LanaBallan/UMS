...
<head>
    ...
    <title>Students Affairs Employees Login</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @guest
                    @if (Route::has('affairs.login'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('affairs.login') }}">{{ __('Login') }}</a>
                        </li>
                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('affairs.check') }}">
                                    @csrf
